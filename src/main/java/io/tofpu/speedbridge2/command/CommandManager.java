...
public final class CommandManager {
  ...
  public static void load(final @NotNull Plugin plugin) {
    final Function<CommandTree<CommonBridgePlayer>, CommandExecutionCoordinator<CommonBridgePlayer>>
        executionCoordinatorFunction =
            CommandExecutionCoordinator.SimpleCoordinator.simpleCoordinator();

    final Function<CommandSender, CommonBridgePlayer> bridgePlayerFunction =
        sender -> {
    ...
    final Function<CommonBridgePlayer, CommandSender> senderToBridgePlayerFunction =
        CommonBridgePlayer::getPlayer;
    ...
    try {
      manager =
          new BukkitCommandManager<>(
              plugin,
              executionCoordinatorFunction,
              bridgePlayerFunction,
              senderToBridgePlayerFunction);
    ...
    final AnnotationParser<CommonBridgePlayer> annotationParser =
    ...
    annotationParser
        ...
        .registerInjector(
            GameIsland.class,
            (context, annotationAccessor) ->
                new GameIslandParser<CommonBridgePlayer>().parse(context, annotationAccessor));
