...
public final class PluginConfiguration {
  @Setting private final GeneralCategory generalCategory = new GeneralCategory();

  @Setting private final BlockMenuCategory blockMenuCategory = new BlockMenuCategory();

  @Setting private final LeaderboardCategory leaderboardCategory = new LeaderboardCategory();

  @Setting private final LobbyCategory lobbyCategory = new LobbyCategory();
