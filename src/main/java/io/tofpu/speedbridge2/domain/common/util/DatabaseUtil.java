...
public class DatabaseUtil {
  public static CompletableFuture<Void> databaseQueryExecute(
      final String sql, final Consumer<DatabaseQuery> databaseQueryConsumer) {
    return runAsync(
        () -> {
  ...
  public static CompletableFuture<Void> databaseQuery(
      final String sql, final Consumer<DatabaseSet> databaseQueryConsumer) {
    return runAsync(
        () -> {
          try (final DatabaseQuery query = DatabaseQuery.query(sql)) {
