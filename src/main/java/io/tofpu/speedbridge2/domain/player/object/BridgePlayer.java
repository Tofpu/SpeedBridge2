...
public final class BridgePlayer extends CommonBridgePlayer<Player>
    implements SessionScore, BlockChoice, SetupMeta {
  ...
  public void setInternalStat(final PlayerStat internalStat) {
    this.statsMap.put(internalStat.getKey().toUpperCase(Locale.ENGLISH), internalStat);
  }
  ...
  public String toString() {
    ...
    sb.append(", statsMap=").append(statsMap);
    sb.append(", sessionMap=").append(sessionMap);
    sb.append(", name='").append(name).append('\'');
    sb.append(", player=").append(player);
    sb.append(", gamePlayer=").append(gamePlayer);
    sb.append(", chosenBlock=").append(chosenBlock);
    sb.append(", setup=").append(inSetup);
    sb.append('}');
    return sb.toString();
  }
}
