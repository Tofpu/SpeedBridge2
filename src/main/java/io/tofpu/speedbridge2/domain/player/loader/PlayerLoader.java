...
public final class PlayerLoader extends CacheLoader<UUID, BridgePlayer>
    implements BoardRetrieve<BridgePlayer> {
  ...
  public BridgePlayer retrieve(final @NotNull UUID uniqueId) {
    ...
    try {
      ...
      bridgePlayer = Databases.PLAYER_DATABASE.getStoredPlayer(uniqueId).get();
