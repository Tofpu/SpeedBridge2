...
public final class IslandLoader extends CacheLoader<UUID, IslandBoardPlayer>
    implements BoardRetrieve<IslandBoardPlayer> {
  ...
  @Override
  public ListenableFuture<IslandBoardPlayer> reload(
      final @NotNull UUID key, final @NotNull IslandBoardPlayer oldValue) {
