...
public final class IslandPlot {
  ...
  public IslandPlot(final Island island, final World world, double[] positions) {
    ...
    this.minPoint = regionWrapper.getMinimumPoint().subtract(origin).add(this.x, y, this.z);
    this.maxPoint = regionWrapper.getMaximumPoint().subtract(origin).add(this.x, y, this.z);
  ...
  public void generatePlot() throws WorldEditException {
    ...
    try (final EditSessionWrapper editSessionWrapper =
      ...
      final Operation operation =
          MultiWorldEditAPI.getMultiWorldEdit()
  ...
  public String toString() {
    ...
    sb.append(", plotState=").append(plotState);
    sb.append('}');
    return sb.toString();
  }
}
