...
public final class IslandService {
  ...
  public @NotNull IslandHandler.IslandCreationResult createIsland(
      final int slot, final @NotNull String category, final String schematic) {
  ...
  public @Nullable GameIsland findGameByPlayer(final GamePlayer gamePlayer, final Island island) {
