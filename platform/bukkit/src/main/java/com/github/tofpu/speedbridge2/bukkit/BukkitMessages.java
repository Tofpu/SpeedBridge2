...
public enum BukkitMessages implements ConfigurableMessage {
    ...
    GAME_SETUP_NOT_READY("game_setup_not_ready", ChatColor.YELLOW + "You must set the player spawn-point to complete the setup!"),
    GAME_SETUP_SET_SPAWNPOINT("game_setup_set_spawnpoint", ChatColor.YELLOW + "You have set the spawn-point of the island!"),
    GAME_SETUP_FINALIZED("game_setup_set_spawnpoint", ChatColor.YELLOW + "You have successfully finished the island setup!"),
